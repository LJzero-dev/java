...
public class TestCtrl {
	...
	public String test(Model model, @RequestParam(value = "name", 
		defaultValue="aaa", required = false) String name) {
	...
	// required : 생략가능. 필수여부로 true일 경우 name파라미터가 없으면 400 오류 발생하며 기본값은 false
	...
	// 사용자의 요청을 받는 컨트롤러이므로 HttpServletRequest객체도 받아올 수 있음
