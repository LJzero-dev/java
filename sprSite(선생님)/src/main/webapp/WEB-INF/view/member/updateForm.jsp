...
<p class="pLine">이메일 : 
	...
	<select name="e2" id="e2">
		...
		<% if(e3.equals("naver.com")) { %>selected="selected"<% } %>>네이버</option>
		<option value="nate.com" 
		<% if(e3.equals("nate.com")) { %>selected="selected"<% } %>>네이트</option>
		<option value="gmail.com" 
		<% if(e3.equals("gmail.com")) { %>selected="selected"<% } %>>지메일</option>
...
<p class="pLine">광고 수신 :
	...
	<% if(mi.getMi_isad().equals("y")) { %>checked="checked"<% } %> />
	<label for="adY">받음</label>&nbsp;&nbsp;&nbsp;&nbsp;
	<input type="radio" name="mi_isad" value="n" id="adN" 
	<% if(mi.getMi_isad().equals("n")) { %>checked="checked"<% } %> />
